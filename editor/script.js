    ...
    blocks: [
      {
        ...
        activate: true,
          ...
          id: 'Footer',
          label: '<b style="font-size: 20px;">Footer</b>',
          select: true,
          content: `<div class="Footer" style="height: 300px; background: black; color:white; margin-top: 393px;box-sizing: border-box;padding: 15px;">
          <f1 style=" font-size: 30px; width: 400px; margin-left: 100px;margin-top:20px; padding: 5px;">Footer</f1>
          <f1 style=" font-size: 30px; width: 400px; margin-left: 300px;margin-top:20px; padding: 5px;">Footer</f1>
          <f1 style=" font-size: 30px; width: 400px; margin-left: 250px;margin-top:20px; padding: 5px;">Footer</f1>
